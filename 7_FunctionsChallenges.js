...
function stringLastIndexOf (word, secondStr){
...
function removeFromString (string, strIndex, numChar){
  return string.slice(strIndex + numChar)
}
...
function indexOf (array1, number1){
...
function includes(collection, value, index) {
  // The line below checks if the collection is an array or a string without an index; 
  ...
  // The line below checks if the collection is an array or a string with an index
  ...
  // The line below checks if the collection is an object and evaluates whether the object holds the value;  
